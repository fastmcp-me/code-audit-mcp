...
export type RequiredAuditRequest = Required<
  Pick<AuditRequest, 'code' | 'language' | 'auditType'>
>;
export type PartialAuditResult = Partial<AuditResult> &
  Pick<AuditResult, 'requestId' | 'issues'>;
